...
function LoginRegisterFlipbook({itemsE, itemsD, index, className}:LoginzadaProps){
    ...
    return (
        ...
        className={"relative z-0 h-[60%] w-[60%] rounded-xl text-black" + ` ${className}`}>
                ...
                <AnimatePresence mode="sync">
                    ...
                    className="absolute left-1/2 z-[2] border-[0.5px] border-primary-foreground h-[100%]"/>
                </AnimatePresence>
        </div>
    );
}
